...
12. [Video6] 
     ...
     5. вы можете отключить слой `silks screen` или удалить текст на слое `F.Fab`, если хотите.
     6. Теперь подключите все соединения между RPi и датчиками одно за другим. Начните с контактов UART, а затем линий I2C, затем подключите все контакты питания и заземления.
     7. Вы можете назначить 3D для футпринтов, если хотите, я назначу 3D для Raspberry и датчиков.
     8. Посмотрим результат в 3D виде.
     9. Таким образом, вы уже создали свою первую плату в KiCad.
